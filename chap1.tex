...
\begin{table}[htbp]
	...
	\begin{center}
		\scalebox{.95}{\input{/media/jason/Dropbox/github/land-reform/paper/placebo-tests}}
	\end{center}
\end{table}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{/media/jason/Dropbox/github/land-reform/paper/plots/mc-exp-pc.png}
