\chapter{Supplementary Tables and Figures for Chapter \ref{ga-lottery}}
...
\begin{table}[htbp] 
	\begin{center}
		...
		\resizebox{0.9\width}{!}{\input{/media/jason/Dropbox/ga-lottery-local/online-appendix/officeholder-robust-table}}
	\end{center}
...
\begin{table}[htbp] 
	\begin{center}
		...
		\resizebox{0.9\width}{!}{\input{/media/jason/Dropbox/ga-lottery-local/online-appendix/candidate-robust-table}}
	\end{center}
...
\begin{table}[htbp] 
	\begin{center}
		...
		\resizebox{0.9\width}{!}{\input{/media/jason/Dropbox/ga-lottery-local/online-appendix/slave-robust-table}}
	\end{center}
