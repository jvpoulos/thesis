...
Beside the negative selection in terms of labor market skill, \citet{bazzi2017frontier} argue that the frontier attracted individualists who would be able to thrive in the harsh conditions (e.g., the isolation and low population density) characterizing the frontier experience. The authors find that counties with longer historical frontier experience exhibit lower contemporary property tax rates, and its citizens are more opposed to taxation and redistribution. 
...
\section{Counterfactual history and covariate shift}


%sunstein2016historical
In a sense, they are constructing something like a randomized controlled
trial, at least in their own minds. As Elster puts it, “in a non-experimental and non-
comparative discipline one can hardly discuss the relative importance of causes without
engaging in some kind of though experiment where one removes successively and
separately each of the causes in question and evaluates what difference the absence of
this cause would have made to the phenomenon in question.'' \citet{elster1978logic}

%fearon1991counterfactuals
%tetlock1996counterfactual
	Philip Tetlock and Aaron Belkin specify a
	set of criteria for assessing counterfactual arguments. 8 Tetlock and Belkin rightly urge,
	“We can avoid counterfactuals only if we eschew all causal inference and limit ourselves
	to strictly noncausal narratives of what actually happened.” 9 To discipline counterfactual
	history, they emphasize the importance of well-specified antecedents and consequents, of
	logical consistency among connecting principles, of avoiding preposterous claims about
	causality, and of maintaining consistency with well-established historical facts

%fogel1964railroads, fogel1962quantitative
	"what would the U.S. economy have been like in 1890 had there been no railroads?"
%donaldson2016railroads
%Williamson: Late Nineteenth-Century American Development: A General Equilibrium History

\subsection{Covariate shift}

The problem of covariate shift is a special case of domain adaptation \citep{huang2007correcting,ben2007analysis,bickel2009discriminative,cortes2010learning,2015arXiv150507818G}. \citet{schnabel2016recommendations} first connected the matrix completion problem with causal inference in observational settings in the context of recommender systems under confounding. \citet{johansson2016learning} formulates the general problem of counterfactual inference as a covariate shift problem.

The covariate shift problem occurs when training and test data are drawn from different distributions. 
...
%johansson2016learning
	...
	%We focus on counterfactual questions raised by what are known as observational studies. Observational studies are studies where interventions and outcomes have been recorded, along with appropriate context.
